...
const RestaurantDetails = () => {
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 1; i <= 5; i++) {
      if (i <= fullStars) {
        stars.push(<Ionicons key={i} name="star" size={18} color="#FFD700" style={{marginRight: 2}} />);
      } else if (i === fullStars + 1 && halfStar) {
        stars.push(<Ionicons key={i} name="star-half" size={18} color="#FFD700" style={{marginRight: 2}} />);
      } else {
        stars.push(<Ionicons key={i} name="star-outline" size={18} color="#FFD700" style={{marginRight: 2}} />);
      }
    }
        ...
        return (
          <View style={styles.tabContent}>
            {restaurant.menuSections?.length > 0 ? (
              ...
              <Text style={styles.emptyStateText}>Menu information coming soon!</Text>
            )}
          </View>
        );
      case 'reviews':
        return (
          <View style={styles.tabContent}>
            <View style={styles.reviewSummary}>
              <Text style={styles.reviewRating}>{restaurant.rating.toFixed(1)}</Text>
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={{ uri: restaurant.images?.[0] || 'https://via.placeholder.com/400x200?text=No+Image' }} 
        ...
        <View style={styles.actionContainer}>
          <TouchableOpacity 
            ...
            onPress={() => router.push(`/reservation?restaurantId=${id}`)}
          >
        ...
        <View style={styles.tabContainer}>
          <TouchableOpacity 
            style={[styles.tabItem, activeTab === 'overview' && styles.selectedTab]}
            onPress={() => setActiveTab('overview')}
          >
            <Text style={[styles.tabText, activeTab === 'overview' && styles.selectedTabText]}>
              Overview
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text style={[styles.tabText, activeTab === 'menu' && styles.selectedTabText]}>
              Menu
            </Text>
          </TouchableOpacity>
          
          <TouchableOpacity 
            style={[styles.tabItem, activeTab === 'reviews' && styles.selectedTab]}
            onPress={() => setActiveTab('reviews')}
          >
            <Text style={[styles.tabText, activeTab === 'reviews' && styles.selectedTabText]}>
              Reviews
            </Text>
          </TouchableOpacity>
        </View>
